...
const opportunities_in_radgrad = 'QNsgON_JlXg';
const verification_requests_in_radgrad = '5quPEPhLS44';
const degree_plans_in_radgrad = '6zjoDvnRmPY';
const ice_and_levels_in_radgrad = 'm0e-R2F5ol0';
const reviews_in_radgrad = 'KJ5tgWPfo8Q';

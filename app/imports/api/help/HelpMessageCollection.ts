...
class HelpMessageCollection extends BaseCollection {
   ...
   */
  public define({ routeName, title, text, retired = false }: HelpMessageDefine): string {
   ...
   */
  public update(docID: string, { routeName, title, text, retired }: HelpMessageUpdate) {
    this.assertDefined(docID);
    const updateData: HelpMessageUpdate = {};
    if (routeName) {
   ...
   */
  public dumpOne(docID: string): HelpMessageDefine {

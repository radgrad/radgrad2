...
class BaseProfileCollection extends BaseSlugCollection {
  ...
  public removeIt(profileID) {
    ...
    if (!Users.isReferenced(userID)) {
      ...
      [Feeds, CourseInstances, OpportunityInstances, AcademicYearInstances, FeedbackInstances, VerificationRequests, ProfileCareerGoals, ProfileCourses, ProfileInterests,

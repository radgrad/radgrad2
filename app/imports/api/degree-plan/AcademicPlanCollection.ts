...
class AcademicPlanCollection extends BaseSlugCollection {
   ...
   * @returns {*}
   */
  public define({ slug, name, description, academicTerm, coursesPerAcademicTerm, choiceList, retired = false }: AcademicPlanDefine) {
   ...
   */
  public update(instance, { name, academicTerm, coursesPerAcademicTerm, choiceList, retired }: AcademicPlanUpdate) {
   ...
   */
  public dumpOne(docID: string): AcademicPlanDefine {

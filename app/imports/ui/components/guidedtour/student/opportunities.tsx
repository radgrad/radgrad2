        ...
        <div>
          ...
          <List>
            <List.Item style={styles.li}>
              Projects: A research or development project, under faculty supervision. For example, you can work with Kim
              Binsted on the <a href="http://hi-seas.org" rel="noopener noreferrer" target="_blank">HI-SEAS</a> project.
            </List.Item>
            <List.Item style={styles.li}>
              ...
              {' '}
              to <a href="http://www.codeforhawaii.org/" rel="noopener noreferrer" target="_blank">Code For Hawaii</a>.
            </List.Item>
            <List.Item style={styles.li}>
            ...
            <List.Item style={styles.li}>
              Online Learning: For certain technologies, a great place to learn is online. For example, game developers
            ...
            <List.Item style={styles.li}>
              ...
              <a href="http://htdc.org/wetwarewed/" rel="noopener noreferrer" target="_blank"> WetWareWednesday</a> or
              the{' '}

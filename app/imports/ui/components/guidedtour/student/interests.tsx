...
Once you have specified one or more of RadGrad&apos;s
            <strong style={styles.strong}>{props.interests}</strong>
            {' '}
interests, RadGrad can start to filter out opportunities that are unrelated to you. RadGrad can also make suggestions about courses and opportunities that you might not even know about.
          </p>

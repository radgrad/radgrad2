    ...
    <Grid container columns={2}>
      ...
      <Grid.Column width="six" textAlign="left">
        <div>
          ...
          <p style={styles.p}>
To help you recall the decisions made and actions taken during your meetings, RadGrad
            provides the Advisor Meeting Log.
          </p>
          <p style={styles.p}>
Only Advisors can make entries in this log, but both you and your Advisor can see the
            entries after they have been created.
          </p>
          <p style={styles.p}>
To get the most out of RadGrad, be sure to meet with your advisor once a semester. And,

      ...
      <Grid.Row centered={true}>
        <Grid.Column width={'twelve'}>
          <div style={styles.p}>
            ...
            <p>If you have a RadGrad account, then please login, update your profile if necessary, and see if there are any questions you'd like to answer.</p>
            <p>You might also want to join the <a href="http://uhm-ics-community.slack.com" target="_blank">uhm-ics-community Slack team</a> and check out the #radgrad channel for the latest news and updates.</p>

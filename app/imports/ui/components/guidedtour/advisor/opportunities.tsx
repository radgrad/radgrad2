  ...
  <div>
    <Grid container={true} columns={2}>
      <Grid.Column width={'six'}>
        <a href="/images/guidedtour/guidedtour-pendingverifications.png" target="_blank"><Image rounded={true} src="/images/guidedtour/guidedtour-pendingverifications.png"/><p style={styles.p}>Click for full-size image</p></a>
      </Grid.Column>
      <Grid.Column width={'ten'} textAlign={'left'}>
        <div>
          ...
          <p style={styles.p}>But planning to experience a hackathon by adding it to your RadGrad degree plan does not mean that you will show up on the day and participate. RadGrad requires that opportunities be <strong style={styles['.guided-tour-description > p strong, .guided-tour-description ul > li strong']}>verified</strong> before the points associated with them are actually awarded to students.</p>

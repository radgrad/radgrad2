  ...
  const explorerFilterValues = (type) => {
    ...
    switch (type) {
      ...
      case EXPLORER_TYPE.COURSES:
        allowedFilterValues = [EXPLORER_FILTER_KEYS.NONE, EXPLORER_FILTER_KEYS.INPROFILE, EXPLORER_FILTER_KEYS.NOTINPROFILE, EXPLORER_FILTER_KEYS.THREEHUNDREDPLUS, EXPLORER_FILTER_KEYS.FOURHUNDREDPLUS, EXPLORER_FILTER_KEYS.SIXHUNDREDPLUS];
        break;
    }

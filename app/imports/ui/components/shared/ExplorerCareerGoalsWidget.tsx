            ...
            <Grid.Row verticalAlign={'middle'}>
              {
                userStatus(item, props) ?
                  <Button onClick={handleDelete(props)} size={'mini'} color={'green'} floated={'right'} basic={true}>DELETE
                    FROM CAREER
                    GOALS</Button>
                  :
                  <Button size={'mini'} onClick={handleAdd(props)} color={'green'} floated={'right'} basic={true}>ADD TO
                    CAREER GOALS</Button>
              }

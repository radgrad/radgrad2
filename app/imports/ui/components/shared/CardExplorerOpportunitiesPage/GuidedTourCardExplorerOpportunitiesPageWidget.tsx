...
const GuidedTourCardExplorerOpportunitiesPageWidget = () => {
    ...
    <div style={styles.background} className="guidedTour">
      <Grid container>
        ...
        <Grid.Column width={8} textAlign="left">
          ...
          <p style={styles.p}>This page presents a curated list of Opportunities that the faculty believe will
            complement existing courses and increase your attractiveness to future employers and graduate programs.
          </p>
        </Grid.Column>
        <Grid.Column width={2} />
      </Grid>
...
export default GuidedTourCardExplorerOpportunitiesPageWidget;

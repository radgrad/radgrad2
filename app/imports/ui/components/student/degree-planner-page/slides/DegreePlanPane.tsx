    ...
    <Grid container stackable>
      <Grid.Row centered>
        ...
        <Grid.Column width={11}>
          ...
          <p style={styles.p}>The degree plan pane shows you your courses and opportunities on a semester-by-semester basis.<br />
            ...
            <br /><br />
            Clicking on a course or opportunity will display details about it in the Favorites/Details pane.</p>
        </Grid.Column>
      </Grid.Row>
    </Grid>
  </div>

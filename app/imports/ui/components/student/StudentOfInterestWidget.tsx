...
const courses = (props: IStudentOfInterestWidgetProps) => matchingCourses(props);
...
const itemCount = (props: IStudentOfInterestWidgetProps) => {
    const { type } = props;
    if (isSame(type, 'courses')) {
        return matchingCourses(props).length;
    }
    return matchingOpportunities(props).length;
};
const opportunities = (props: IStudentOfInterestWidgetProps) => matchingOpportunities(props);

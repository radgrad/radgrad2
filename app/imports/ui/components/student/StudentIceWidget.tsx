...
const StudentIceWidget = (props: IStudentIceWidgetProps) => {
  ...
  const styleInfo = { textAlign: 'left', paddingTop: 10 };
          ...
          <Grid.Row>
            <Grid.Column style={innovationColumnStyle}>
              <Segment basic>
                ...
                <div style={styleInfo}>You earn innovation points by completing opportunities that involve &#8220; innovation &#8220;, such as <strong>research projects, hackathons,</strong> or <strong>other activities producing new insights or technologies.</strong> </div>
              </Segment>
            </Grid.Column>
            ...
            <Grid.Column>
              <Segment basic>
                ...
                <div style={styleInfo}>You earn competency points by completing classes.  The number of competency points depends upon your grade: you get <strong>10 points for any kind of A, 6 points for any kind of B, and no points for a C or below</strong>. </div>
              </Segment>
            </Grid.Column>
            ...
            <Grid.Column style={experienceColumnStyle}>
              <Segment basic>
                ...
                <div style={styleInfo}>You earn experience points by completing opportunities that provide &#8220;real world experience&#8220;, such as <strong>internships</strong> or <strong>business plan competitions</strong>.</div>
              </Segment>
            </Grid.Column>
          </Grid.Row>
        </Grid>

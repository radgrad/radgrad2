...
const GuidedTourStudentSetUp: React.FC = () => (
  <div>
    <Grid container columns={2}>
      <Grid.Column width="nine">
        <a href="/images/guidedtour/guidedtour-setup.png" target="_blank">
          <Image rounded src="/images/guidedtour/guidedtour-setup.png" />
      ...
      <Grid.Column width="seven" textAlign="left">
        <div>
          ...
          <p style={styles.p}>
            If you are a new student with minimal knowledge about computer science, your advisor will give you a basic overview, then create your RadGrad account. You&apos;ll then work together to get a handle on your interests, career
            goals, and degree plan. If you have questions about any of those, RadGrad is designed to help you answer them.
          </p>

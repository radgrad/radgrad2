...
const GuidedTourFacultyVerification: React.FC = () => (
  <div>
    <Grid container columns={2}>
      <Grid.Column width="nine">
        <a href="/images/guidedtour/guidedtour-faculty-verification.png" target="_blank">
          <Image rounded src="/images/guidedtour/guidedtour-faculty-verification.png" />
...
export default GuidedTourFacultyVerification;

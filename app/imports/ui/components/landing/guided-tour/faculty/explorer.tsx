...
const GuidedTourFacultyExplorer: React.FC = () => (
  <div>
    <Grid container columns={2}>
      ...
      <Grid.Column width="seven" textAlign="left">
        <div>
          ...
          <p style={styles.p}>
            As a faculty member, you are an invaluable source of insight into computer science disciplinary areas
            (&quot;interests&quot;) as well as rewarding and/or emerging career goals.
          </p>
          <p style={styles.p}>

    ...
    <Grid container columns={2}>
      ...
      <Grid.Column width="seven" textAlign="left">
        <div>
          ...
          <p style={styles.p}>
            It&apos;s useful to specify your disciplinary areas (&quot;interests&quot;) as well as career goals for which you have some expertise. Your profile picture will then be associated with these interests and career goals, and
            students will know to come to you for advising.
          </p>
        </div>
      </Grid.Column>
    </Grid>

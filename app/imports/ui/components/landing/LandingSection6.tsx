      ...
      <Grid columns={2} centered={true} padded={true} stackable={true}>
        ...
        <Grid.Column textAlign={'center'}>
          ...
          <div style={styles['header-description']}>
            ...
            <p>
              Right now, there are <strong>{props.levelOne}</strong> student(s) at Level One,&nbsp;
              <strong>{props.levelTwo}</strong> at Level Two, <strong>{props.levelThree}</strong> at Level
              Three, <strong>{props.levelFour}</strong> at Level
              Four, <strong>{props.levelFive}</strong> at
              Level Five, and <strong>{props.levelSix}</strong> at Level Six.
            </p>
            <p>

...
import AdminDataModelInternshipPage from '../../pages/admin/AdminDataModelInternshipPage';
...
export const routes = {
  ADMIN: [
    ...
    { path: `/${URL_ROLES.ADMIN}/${USERNAME}/${DATAMODEL.INTERNSHIPS}`, component: AdminDataModelInternshipPage },

...
class AdminDataModelPlanChoicesPage extends React.Component<{}, IAdminDataModelPageState> {
  ...
  private handleAdd = (doc) => {
    // console.log('PlanChoices.handleAdd(%o)', doc);
  ...
  private handleUpdate = (doc) => {
    // console.log('PlanChoices.handleUpdate doc=%o', doc);
    const collectionName = collection.getCollectionName();

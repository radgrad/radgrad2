...
interface IAdminDataModelOpportunityTypesPageProps extends IAdminDataModeMenuProps {
  items: IOpportunityType[];
}

const AdminDataModelOpportunityTypesPage = (props: IAdminDataModelOpportunityTypesPageProps) => {
...
export default withInstanceSubscriptions(AdminDataModelOpportunityTypesPageContainer);

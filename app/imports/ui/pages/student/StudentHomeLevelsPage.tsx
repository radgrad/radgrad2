              ...
              <Card.Group itemsPerRow={3}>
                <Card>
                  <Card.Content>
                    ...
                    <Card.Description>
                      ...
                      first sign up for RadGrad with your advisor.
                      <em>&quot;A journey of a thousand miles begins with a
                ...
                <Card>
                  <Card.Content>
                    ...
                    <Card.Description>
                      Successfully finish your first academic term of ICS coursework. Then meet with your advisor and
                      ask
                ...
                <Card>
                  <Card.Content>
                    ...
                    <Card.Description>
                      ...
                      with your current STAR data, and if the system shows you&apos;ve gotten to Level 3, you&apos;ll
                      get
                ...
                <Card>
                  <Card.Content>
                    ...
                    <Card.Description>
                      ICS has a &quot;core curriculum&quot;, and Level 4 students have not only finished it, but they
                      have
                ...
                <Card>
                  <Card.Content>
                    ...
                    <Card.Description>
                      If you achieve Level 6, you are truly one of the elite ICS students, and you will have
                      demonstrated
                      excellent preparation for entering the workforce, or going on to Graduate School, whichever you
                      prefer. Congratulations! Note that in addition to fulfilling the ICE requirements, you&apos;ll
                      also need
                      to &quot;pay it forward&quot; to the RadGrad community in order to obtain your Black RadGrad
                      laptop
                      sticker.
                    </Card.Description>
                  </Card.Content>

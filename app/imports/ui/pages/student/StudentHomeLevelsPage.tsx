            ...
            <Card.Group itemsPerRow={3}>
              <Card>
                <Card.Content>
                  ...
                  <Card.Description>
                    You begin your RadGrad experience at Level 1, and you will receive this
                    laptop sticker when you
                    first sign up for RadGrad with your advisor. <em>&quot;A journey of a
              ...
              <Card>
                <Card.Content>
                  ...
                  <Card.Description>
                    Successfully finish your first academic term of ICS coursework. Then meet
                    with your advisor and ask
                    him/her to update RadGrad with your current STAR data. That should bring you
                    to Level 2, and earn
              ...
              <Card>
                <Card.Content>
                  ...
                  <Card.Description>
                    With any luck, you&apos;ll achieve Level 3 after you complete your second
                    academic term of ICS
                    coursework, as long as your grades are good. As before, meet with your
                    Advisor to update RadGrad
                    with your current STAR data, and if the system shows you&apos;ve gotten to
                    Level 3, you&apos;ll get
              ...
              <Card>
                <Card.Content>
                  ...
                  <Card.Description>
                    ICS has a &quot;core curriculum&quot;, and Level 4 students have not only
                    finished it, but they have
                    also thought beyond mere competency. Once your current STAR data is in
                    RadGrad, and you&apos;ve
                    achieved some verified opportunities, you might just find yourself at Level
                    4! Meet with your
              ...
              <Card>
                <Card.Content>
                  ...
                  <Card.Description>
                    Level 5 students are far along in their degree program, and they&apos;ve
                    made significant progress
                    toward 100 verified points in each of the three ICE categories. You will
                    probably be at least a
                    Junior before Level 5 becomes a realistic option for you. Keep your STAR
                    data current in RadGrad,
                    make sure your opportunities are verified, and good luck! Some students
                    might graduate before
                    reaching Level 5, so try to be one of the few that make it all the way to
                    here!
                  </Card.Description>
                </Card.Content>
              </Card>
              <Card>
                <Card.Content>
                  ...
                  <Card.Description>
                    If you achieve Level 6, you are truly one of the elite ICS students, and you
                    will have demonstrated
                    excellent preparation for entering the workforce, or going on to Graduate
                    School, whichever you
                    prefer. Congratulations! Note that in addition to fulfilling the ICE
                    requirements, you&apos;ll also need
                    to &quot;pay it forward&quot; to the RadGrad community in order to obtain
                    your Black RadGrad laptop
                    sticker.
                  </Card.Description>
                </Card.Content>
              </Card>

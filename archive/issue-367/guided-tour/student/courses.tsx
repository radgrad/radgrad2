    ...
    <Grid container columns={2}>
      <Grid.Column width="ten">
        <a href="/images/guidedtour/guidedtour-courses.png" target="_blank">
          <Image rounded src="/images/guidedtour/guidedtour-courses.png" />
      ...
      <Grid.Column width="six" textAlign="left">
        <div>
          ...
          <p style={styles.p}>
            Want to get a fellow student&apos;s perspective on a course? RadGrad allows you to create a review for any course you have completed, and currently provides
            <strong style={styles.strong}> {courseReviews}</strong> reviews. Note that these reviews are public, and your name appears with your review. We think RadGrad course reviews are one of the best features of the system.
          </p>
        </div>
      </Grid.Column>
    </Grid>
